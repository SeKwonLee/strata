...
%token FSC_LIST FSC_DEFINE FSC_QUIT FSC_DEBUG FSC_CREATE FSC_SLEEP FSC_SET FSC_DIGEST
...
%type <ival> FSC_DEFINE FSC_SET FSC_RUN FSC_ENABLE FSC_PSRUN FSC_DIGEST
...
%type <cmd> proc_define_command files_define_command digest_define_command
...
digest_define_command: FSC_DEFINE FSC_DIGEST
{
	$$ = alloc_cmd();
	if (!$$)
		YYERROR;
...
| FSA_NICE { $$ = FSA_NICE;}
| FSA_MLFS_DEV_ID { $$ = FSA_MLFS_DEV_ID;}
